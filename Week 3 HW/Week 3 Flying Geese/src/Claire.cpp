...
void Goose:: draw(float xPos, float yPos){
    ...
    third.draw(xPos - ofGetWidth()/4, yPos + ofGetHeight()/5, 150, 100);

    third.draw(xPos - 2*ofGetWidth()/4, y - 2*ofGetHeight()/5, 150, 100);
